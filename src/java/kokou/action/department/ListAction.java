...
package kokou.action.department;
...
import kokou.mapper.DepartmentMapper;
...
public class ListAction extends DefaultAction {
    ...
    public void execute() {
        DepartmentMapper departmentMapper = new DepartmentMapper(getSqlSession());
        final Response res = new Response();
        res.success = true;
        res.dataList = new ArrayList();
        departmentMapper.getAll(new ResultHandler() {
            @Override
