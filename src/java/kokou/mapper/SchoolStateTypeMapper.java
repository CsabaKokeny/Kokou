 ...
 * @author master
 */
public class SchoolStateTypeMapper extends DefaultMapper {
    public String namespace = "kokou.mapper.SchoolStateTypeMapper.";

    public SchoolStateTypeMapper(SqlSession sqlSession) {
        super(sqlSession);
    }
