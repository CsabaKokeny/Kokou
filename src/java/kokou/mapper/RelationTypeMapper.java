 ...
 * @author master
 */
public class RelationTypeMapper extends DefaultMapper {
    public String namespace = "kokou.mapper.RelationTypeMapper.";

    public RelationTypeMapper(SqlSession sqlSession) {
        super(sqlSession);
    }
