Ext.define('Kokou.view.teacher.Edit', {
    ...
    createMainEditPanel: function () {
        return this.mainEditPanel = Ext.create('Kokou.view.teacher.edit.MainEditPanel', {
            userConfig: this.userConfig,
            height: 470
        });
    },
    createCardInfoEditPanel: function () {
        return Ext.create('Kokou.view.teacher.edit.CardInfoEditPanel', {
            height: 470,
            userConfig: this.userConfig,
            readOnly:true
        });
    ...
    createCareerPanel: function () {
        return Ext.create('Kokou.view.teacher.edit.CareerList',{
            closable: false,
            title: '■【入職前の経歴】',
            width: '100%',
            height: 470
    ...
    createFamilyPanel: function () {
        return Ext.create('Kokou.view.teacher.edit.FamilyList',{
            closable: false,
    ...
    createContactPanel: function () {
        return Ext.create('Kokou.view.teacher.edit.ContactList',{
            closable: false,
            title: '■【緊急時の連絡（保護者以外）】',
            width: '100%',
            height: 470
    ...
    createBusPanel: function () {
        return Ext.create('Kokou.view.teacher.edit.BusList',{
            closable: false,
            title: '■【通勤方法】',
            width: '100%',
            height: 470
    ...
    createRewardPunishmentPanel: function () {
        return Ext.create('Kokou.view.teacher.edit.RewardPunishmentList',{
            closable: false,
            title: '■【賞罰】',
            width: '100%',
            height: 470
