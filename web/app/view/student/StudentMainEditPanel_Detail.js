Ext.define('Kokou.view.student.StudentMainEditPanel_Detail',{
        ...
        _this.items = [
            _this.factory.createHidden({name:'id'}),
            {
                ...
                items: [
                    ...
                    {columnWidth:0.1, html:'&nbsp;'},
                    _this.factory.createText({id:"txtSchoolYear", name: 'schoolYear',fieldLabel: '学年', columnWidth:0.25, labelWidth: 50, tag: 'enterSchoolYear', readOnly:true,})
                ]
            },
            {
                xtype: 'fieldset',
                ...
                items: [
                    {
                        ...
                        border: 0,
                        items: [
                            _this.factory.createText({readOnly:true,id:'txtStudentName', name: 'name', fieldLabel: '氏名', tag:'name'}),
                            _this.factory.createText({readOnly:true,id:'txtStudentNameKr', name: 'nameKr', fieldLabel: 'ハングル名', tag:'nameKr'}),
                            _this.factory.createDate({readOnly:true,id:'dtStudentBirth', name: 'birth',fieldLabel: '生年月日（西暦）', tag:'birth'}),
                            _this.factory.createText({readOnly:true,id:'txtStudentAddress', name: 'address', fieldLabel: '現住所', tag:'address'}),
                            _this.factory.createText({readOnly:true,id:'txtStudentPhone', name: 'phone', fieldLabel: 'ＴＥＬ', tag:'phone'}),
                            _this.factory.createNationComboBox({readOnly:true,id:'cbxStudentNation', name: 'nation', fieldLabel: '本籍', tag:'nation'})
                        ]
                    },
                    {
                        xtype: 'fieldset',
                        ...
                        border:0,
                        items: [
                            _this.factory.createText({readOnly:true,id:'txtStudentNameNick', name: 'nameNick', fieldLabel: '通称名', tag:'nameNick'}),
                            _this.factory.createSexComboBox({readOnly:true,id:'cbxStudentSex', name: 'sex', fieldLabel: '性別', tag:'sex'}),
                            {html:'<div style="height:24px;">&nbsp;</div>'},
                            _this.factory.createText({readOnly:true,id:'txtStudentAddress2', name: 'address2', fieldLabel: '変更住所', tag:'address2'}),
                            _this.factory.createText({readOnly:true,id:'txtStudentFax', name: 'fax', fieldLabel: 'ＦＡＸ', tag:'fax'}),
                            {html:'&nbsp;'}
                        ]
                    }
                ]
