Ext.define('Kokou.view.student.StudentHealthInfoEditPanel_Detail', {
        ...
        _this.items = [
            {
                ...
                title: 'アレルギー',
                items:[
                    _this.factory.createCheckbox({id:'chkHasAllergy', name: 'hasAllergy', fieldLabel: '有・無', tag:'has', readOnly: true})  ,
                    _this.factory.createText({id:'txtAllergyName', name: 'allergyName', fieldLabel: 'アレルゲン名', tag:'name', readOnly: true}),
                    {html:'&nbsp;'}
                ]
            },
            {
