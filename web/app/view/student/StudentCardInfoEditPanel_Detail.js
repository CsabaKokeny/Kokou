Ext.define('Kokou.view.student.StudentCardInfoEditPanel_Detail',{
        ...
        _this.items = [
            {
                ...
                title: '旅券',
                items:[
                    _this.factory.createCheckbox({id:'chkHasPassport', name: 'hasPassport', fieldLabel: '有・無', readOnly: true})  ,
                    _this.factory.createText({id:'txtPassportNo', name: 'passportNo', fieldLabel: '旅券番号',readOnly:true}),
                    {html:'&nbsp;'}
                ]
            },
            {
                ...
                title: '日本国籍以外の生徒',
                items:[
                    _this.factory.createText({id:'txtForeignerNo', name: 'foreignerNo', fieldLabel: '外国人登録番号', readOnly: true}),
